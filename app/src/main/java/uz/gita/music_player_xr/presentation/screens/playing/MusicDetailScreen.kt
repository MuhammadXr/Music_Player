package uz.gita.music_player_xr.presentation.screens.playing
...
import uz.gita.music_player_xr.databinding.ScreenMusicDetailBinding
import uz.gita.music_player_xr.presentation.viewmodels.MusicDetailViewModel
import uz.gita.music_player_xr.presentation.viewmodels.impl.MusicDetailViewModelImpl
import uz.gita.music_player_xr.utils.MusicPlaying
import uz.gita.music_player_xr.utils.extensions.formatDuration
...
class MusicDetailScreen : Fragment(R.layout.screen_music_detail) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (isPlaying) {
            binding.iconStopOrPlay.setImageResource(R.drawable.ic_baseline_pause_24)
        } else {
            binding.iconStopOrPlay.setImageResource(R.drawable.ic_baseline_play_arrow_54)
        }
